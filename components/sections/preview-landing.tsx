          ...
          <div className="mt-6" data-id={item.id} key={item.id}>
            <div className="checkerboard relative flex items-start justify-center rounded-xl">
              ...
              <Link
                ...
                target="_blank"
                href={`https://pinterest.com/pin/create/button/?url=https://pinterest.com/pin/create/button/?description=${encodeURIComponent(`${item.inputPrompt!} Generator by remove-anything.com`)}&url=${encodeURIComponent(item.imageUrl!)}`}
              >
