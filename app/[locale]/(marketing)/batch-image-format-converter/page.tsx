...
export async function generateMetadata({
  ...
  const copy = getBatchImageToolCopy(locale, "batch-image-format-converter");
...
export default function BatchImageFormatConverterPage({
  params: { locale },
}: PageProps) {
  unstable_setRequestLocale(locale);

  return <BatchImageTool locale={locale} variant="batch-image-format-converter" />;
}
