...
export async function generateMetadata(
  ...
  const toolCopy = getBackgroundToolCopy(locale, "change-background-color");
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Background color changer before and after example",
        },
      ],
...
export default async function ChangeBackgroundColorPage({
  ...
  return <MarketingRemoveBackground locale={locale} variant="change-background-color" />;
}
