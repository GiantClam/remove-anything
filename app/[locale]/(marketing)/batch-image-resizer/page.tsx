...
export async function generateMetadata({
  ...
  const copy = getBatchImageToolCopy(locale, "batch-image-resizer");
...
export default function BatchImageResizerPage({
  params: { locale },
}: PageProps) {
  unstable_setRequestLocale(locale);

  return <BatchImageTool locale={locale} variant="batch-image-resizer" />;
}
