...
export async function generateMetadata(
  ...
  const toolCopy = getBackgroundToolCopy(locale, "white-background");
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "White background maker before and after example",
        },
      ],
...
export default async function WhiteBackgroundMakerPage({
  params: { locale },
}: PageProps) {
  unstable_setRequestLocale(locale);

  return <MarketingRemoveBackground locale={locale} variant="white-background" />;
}
